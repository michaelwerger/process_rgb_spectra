...
def main():
    ...
    parser.add_argument('--object', dest='section', default='ALPLYR', help='ALPLYR|GAMCYG')
    parser.add_argument('--configfile', dest='configfile', default='processing.cfg', help='name for config file')
    ...
    if config.has_option(section,'coeff'):
        ...
        config.set(section,'positions',value=str(dc.getPositions))
        config.set(section,'wavelengths',value=str(dc.getWavelengths))
